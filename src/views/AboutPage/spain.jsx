...
const spain = () => {
    return (
        <div>
            ...
            <p>Fecha efectiva: February 07, 2019</p>


            <p>AsMuch何とか ("nosotros", "a nosotros", "nuestro") opera el sitio web https://www.asmuch.xyz/ (en adelante, el "Servicio").</p>
            ...
            <p>Utilizamos sus datos para prestarle el Servicio y mejorarlo. Al utilizar el Servicio, usted acepta la recopilación y el uso de información de conformidad con esta política. A menos que esta Política de privacidad defina lo contrario, los términos utilizados en ella tienen los mismos significados que nuestros Términos y Condiciones, disponibles en el https://www.asmuch.xyz/</p>

            <h2>Definiciones</h2>
            <ul>
                <li>
                    <p><strong>Servicio</strong></p>
                    <p>Servicio es el sitio web https://www.asmuch.xyz/ operado por AsMuch何とか</p>
                </li>
                <li>
...
Servicio y mejorarlo.</p>
            ...
            <ul>
                <li>Dirección de e-mail</li>                <li>Cookies y datos de uso</li>
            </ul>
            ...
            <p>Usted puede ordenar a su navegador que rechace todas las cookies o que le avise cuando se envía una cookie. Sin embargo, si no acepta cookies, es posible que no pueda utilizar algunas partes de nuestro Servicio. Puede obtener más información sobre cómo administrar las cookies en la <a href="https://privacypolicies.com/blog/how-to-delete-cookies/">Guía de cookies del navegador</a>.</p>
            ...
            <h2>Uso de datos</h2>
            <p>AsMuch何とか utiliza los datos recopilados con diversas finalidades:</p>
            <ul>
            ...
            <p>Si usted se encuentra fuera de Japan y decide facilitarnos información, tenga en cuenta que nosotros transferimos los datos, incluyendo Datos personales, a Japan y que los tratamos allí.</p>
            ...
            <ul>
                <li>Por e-mail: asmuchnantoka@gmail.com</li>
