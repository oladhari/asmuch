...
<p>Date de prise d'effet: February 07, 2019</p>


<p>AsMuch何とか ("nous", "notre", "nos") exploite le site web https://www.asmuch.xyz/ (ci-après désigné par le terme "Service").</p>
...
<ul>
    <li>Adresse e-mail</li>                <li>Cookies et Données d'Utilisation</li>
</ul>
...
<p>Vous pouvez demander à votre navigateur de refuser tous les cookies ou de vous avertir lorsqu'un cookie est envoyé. Toutefois, si vous n'acceptez pas les cookies, il se peut que vous ne puissiez pas utiliser certains éléments de notre Service. Pour en savoir plus sur la gestion des cookies, consultez le <a href="https://privacypolicies.com/blog/how-to-delete-cookies/">Guide des cookies du navigateur</a>.</p>
...
<p>AsMuch何とか utilise les données recueillies à des fins diverses:</p>    
<ul>
...
<p>Si vous résidez hors de/du Japan et que vous choisissez de nous communiquer des informations, sachez que nous transférons les données, y compris les Données à Caractère Personnel, vers le/la Japan et que nous les y traitons.</p>
...
<ul>
    <li>Par courrier électronique: asmuchnantoka@gmail.com</li>
</ul>`;
